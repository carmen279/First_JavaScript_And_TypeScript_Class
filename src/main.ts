...
let pets_and_legs = pets.map(pet => ({name: pet.name, legs: animals.filter(animal => animal.name === pet.animal)[0].legs}))
...
pets_and_legs = pets.map(pet => ({name: pet.name, legs: animals.filter(animal => animal.name === pet.animal)[0].legs}))
let persons_and_legs = persons.map(person => ({name: person.name, legs: pets_and_legs.filter(pet => pet.name === person.pet)[0].legs}))
...
pets_and_legs = pets.map(pet => ({name: pet.name, legs: animals.filter(animal => animal.name === pet.animal)[0].legs}))
let persons_country_and_legs = persons.map(person => ({name: person.name, country: person.country, legs: pets_and_legs.filter(pet => pet.name === person.pet)[0].legs}))
